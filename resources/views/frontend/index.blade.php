      ...
      <div class="row">
        @foreach ($posts as $post)
            <div class="col-lg-4 mb-4">
                <div class="entry2">
                <a href="single.html"><img src="{{asset('uploads/post')}}/{{$post->post_image}}" alt="Image" class="img-fluid rounded"></a>
                <div class="excerpt">
                <span class="post-category text-white bg-secondary mb-3">{{$post->CategoryPost->category_name}}</span>

                <h2><a href="single.html">{{$post->post_tittle}}</a></h2>
                <div class="post-meta align-items-center text-left clearfix">
                    ...
                    <span class="d-inline-block mt-1">By <a href="#">{{$post->UserPost->name}}</a></span>
