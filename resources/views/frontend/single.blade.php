...
@section('content')
<div class="site-cover site-cover-sm same-height overlay single-page" style="background-image: url('{{asset('uploads/post')}}/{{$details_post->post_image}}">
    <div class="container">
      <div class="row same-height justify-content-center">
        <div class="col-md-12 col-lg-10">
          <div class="post-entry text-center">
            <span class="post-category text-white bg-success mb-3">{{ $details_post->CategoryPost->category_name}}</span>
            <h1 class="mb-4"><a href="#"></a>{{ $details_post->post_tittle }}</h1>
            <div class="post-meta align-items-center text-center">
              <figure class="author-figure mb-0 mr-3 d-inline-block"><img src="{{asset('uploads/post')}}/{{$details_post->post_image}}" alt="Image" class="img-fluid"></figure>
              <span class="d-inline-block mt-1">By  {{$details_post->UserPost->name}}</span>
              <span>&nbsp;-&nbsp;{{$details_post->created_at->format('M-d-Y')}}</span>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="container">
      ...
      <div class="row blog-entries element-animate">
        ...
        <div class="col-md-12 col-lg-8 main-content">
          ...
          <p>{!! $details_post->post_description !!}</p>
